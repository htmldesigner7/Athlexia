...
import list_bus1 from "../assets/images/list_bus1.png";
import list_bus2 from "../assets/images/list_bus2.png";
import list_bus3 from "../assets/images/list_bus3.png";
import ProductCard from "../components/hoc/ProductCard";
import TabsProductSlider from "../components/hoc/Poductslider";
import ProductSlider from "../components/hoc/Poductslider";
...
const locations = ["Ahmedabad", "Surat", "Vadodara", "Rajkot"];
    ...
    <>
            ...
            <div className="search_left">
              ...
              <div className="search_left_child">
                ...
                <div className="loc-dropdown" ref={locRef}>
                  <button
                    className={"loc-trigger" + (locOpen ? " open" : "")}
                  ...
                  >
                    ...
                    >
                      <path
                        d="M11.3501 0.5L5.92505 5.92505L0.5 0.5"
                        stroke="#333"
                        strokeLinecap="round"
                  ...
                  {locOpen && (
                    <ul className="cat-menu loc-menu" role="listbox">
                      {locations.map((loc) => (
                        <li
                          key={loc}
                          className={loc === locSelected ? "active" : ""}
                          onClick={() => {
                            setLocSelected(loc);
                            setLocOpen(false);
                          }}
                          role="option"
                          aria-selected={loc === locSelected}
                        >
                          <span>{loc}</span>
                          {loc === locSelected && (
                            <svg
      ...
      <section className="mb_100">
        <div className=" container-fluid">
          <div className="mb_50">
            <h2 className="title_64 mb-3">
              <span className="heade_dot">•</span> Popular Venues Near You
            </h2>
            <p className="title_24">
      ...
      <section className="mb_100">
        <div className="container-fluid">
          <div className="list_bus">
            <div className="list_bus_top">
              <h2 className="title_64 mb-2">List Your Business</h2>
              <p className="title_24">
                Join India' s fastest-growing sports & fitness marketplace.{" "}
                <br /> Be discovered by thousands of athletes, parents, gyms,
                venues & training seekers.{" "}
              </p>
              <a href="#" className="com_btn_red">
                Add My Business
              </a>
            </div>

            <div className="list_bus_bot">
              <div>
                <img src={list_bus1} alt="images" />
                <h4 className="title_36">Verified Listing</h4>
                <p className="title_24">Build trust and credibility</p>
              </div>

              <div>
                <img src={list_bus2} alt="images" />
                <h4 className="title_36">Get More Customers</h4>
                <p className="title_24">Receive verified leads</p>
              </div>

              <div>
                <img src={list_bus3} alt="images" />
                <h4 className="title_36">Pan-India Reach</h4>
                <p className="title_24">Increase your visibility</p>
              </div>
            </div>

            <p className="title_64" style={{ color: "#373132" }}>
